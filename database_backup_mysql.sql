-- Running Health Tracker Database Backup (MySQL Compatible)
-- Generated for CyberPanel / MySQL Import
...
CREATE TABLE `runs` (
    ...
    `pre_heart_rate` INT NOT NULL,
    `pre_systolic` INT NOT NULL,
    `pre_diastolic` INT NOT NULL,
    `pre_temperature` FLOAT NOT NULL,
    `pre_cholesterol` INT NOT NULL,
    `pre_spo2` INT NOT NULL,
    ...
    `post_laps` INT DEFAULT 0,
    `post_distance` FLOAT DEFAULT 0,
    `post_calories` INT DEFAULT 0,
